...
<form id="pagerForm" method="post" action="${ctx}/admin/deliveryRecord/list">
...
<div class="pageHeader">
    <form rel="pagerForm" onsubmit="return navTabSearch(this);" action="${ctx}/admin/deliveryRecord/list" method="post">
        <div class="searchBar">
    ...
    <table class="table" width="100%" layoutH="110">
        ...
        <c:forEach items="${dataList}" var="data">
            <tr target="record_id" rel="${data.record_id}">
                ...
                <td>
                    <a href="${ctx}/admin/deliveryRecord/trackList?record_id=${data.record_id}" target="dialog"
                       mask="true">详情</a>
                </td>
            </tr>
        </c:forEach>
